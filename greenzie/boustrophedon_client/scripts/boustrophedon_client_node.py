...
# from boustrophedon_server import boustropheodon_planner_server
...
def parseValues(axis):  
    ...
    try:
        with open("/home/joe/py_greenzie_catkin_ws/src/maps/arena/" + axis + "_coordinates.txt") as file_reader:
            line = file_reader.readline()
            while line != '':
                points.append(float(line.rstrip("\n")))
                line = file_reader.readline()
    except:
        # print("Could not process the file - " + axis + "_coordinates.txt")
